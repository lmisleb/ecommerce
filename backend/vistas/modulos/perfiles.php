	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="box-header with-border">
				...
				<button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarPerfil">Agregar Perfil</button>
							...
							foreach ($perfiles as $key => $value){
								...
								echo'<tr>
										...
										if($value["foto"] != ""){
											...
											echo '<td><img src="vistas/img/default/anonymous.png" class="img-thumbnail" width="40px"></td>';
									...
									echo '<td>
										...
										<div class="btn-group">
											...
											<button class="btn btn-warning btnEditarPerfil" idPerfil="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarPerfil" title="Editar"><i class="fa fa-pencil"></i></button>

											<button class="btn btn-danger btnEliminarPerfil" idPerfil="'.$value["id"].'" fotoPerfil="'.$value["foto"].'" title="Eliminar"><i class="fa fa-times"></i></button>
				...
				<div class="modal-body">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<img src="vistas/img/default/anonymous.png" class="img-thumbnail previsualizar" width="100px">
