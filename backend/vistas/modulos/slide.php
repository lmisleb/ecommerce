                                    ...
                                    <div class="col-md-4 col-xs-12">
                                       ...
                                       <div class="box-body">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <p class="help-block">Tamaño recomendado 1600px * 500px</p>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control botonSlide" indice="'.$key.'" value="'.$value["boton"].'" placeholder="Colocar el nombre del botón">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control urlSlide" indice="'.$key.'" value="'.$value["url"].'" placeholder="http://www.ejemplo.com">
                                    ...
                                    <div class="col-md-4 col-xs-12">
                                       ...
                                       <div class="box-body">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" indice="'.$key.'" value="" class="slider form-control posVerticalTexto 
                                                posVerticalTexto'.$key.'" 
                                                data-slider-min="0" 
                                                data-slider-max="50"
                                                data-slider-step="5"
                                             ...
                                             if($value["tipoSlide"] == "slideOpcion1"){
                                                ...
                                                echo '<input type="text" indice="'.$key.'" value="" class="slider form-control posHorizontalTexto 
                                                   posHorizontalTexto'.$key.'" 
                                                   tipoSlide = "'.$value["tipoSlide"] .'"
                                                   data-slider-min="0" 
                                                   data-slider-max="50"
                                                   data-slider-step="5"
                                             ...
                                             echo '<label>ANCHO del texto: </label>
                                                ...
                                                <input type="text" indice="'.$key.'" value="" class="slider form-control anchoTexto 
                                                   anchoTexto'.$key.'" 
                                                   data-slider-min="0" 
                                                   data-slider-max="50"
                                                   data-slider-step="5"
