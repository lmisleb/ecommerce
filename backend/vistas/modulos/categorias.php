                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control input-lg valorOferta" id="idPrecioOferta" name="precioOferta" min="0" step="any" placeholder="Precio">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control input-lg valorOferta" id="idDescuentoOferta" name="descuentoOferta" min="0" placeholder="Descuento">
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default pull-left btnClose" data-dismiss="modal">Salir</button>
