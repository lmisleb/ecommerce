	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="box-header with-border">
				...
				<button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarBanner">Agregar Banner</button>
				...
				<div class="modal-body">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<img src="vistas/img/default/default.png" class="img-thumbnail previsualizarBanner" width="100%">
						...
						<div class="form-group  entradaRutaBanner" style="display:none">
							...
							<div class="input-group">
								...
								<select class="form-control input-lg seleccionarRutaBanner" name="rutaBanner"></select>
					...
					<div class="box-body">
						...
						<div class="form-group entradaRutaBanner" style="display:none">
							...
							<div class="input-group">
								...
								<select class="form-control input-lg seleccionarRutaBanner"></select>
