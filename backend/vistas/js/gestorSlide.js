...
$(".agregarSlide").click(function(){
	...
	var estiloTextoSlide = '{"top":"30","right":"","left":"15","width":"40"}';
		...
		success: function(respuesta){
			...
			if(respuesta == "ok"){
				...
				swal({
				  	...
				  	type: "success",
					title: "El slide ha sido guardado satisfactoriamente !",
					showConfirmButton: true,
					confirmButtonText: "Cerrar"
