...
class ModeloSubCategorias{
	...
	static public function mdlActualizarSubCategorias($tabla, $item1, $valor1, $item2, $item3, $valor3){
	...
	static public function mdlActualizarOfertaSubcategorias($tabla, $datos, $ofertadoPor){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET $ofertadoPor = :$ofertadoPor, 
																 oferta = :oferta, 
	...
	static public function mdlIngresarSubCategoria($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(subcategoria, 
																  id_categoria, 
																  ruta, 
																  estado, 
																  oferta, 
