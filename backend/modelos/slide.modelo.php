...
class ModeloSlide{	
	...
	static public function mdlCrearSlide($tabla, $datos, $orden){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, imgFondo, tipoSlide, estiloImgProducto, estiloTextoSlide, titulo1, titulo2, titulo3, boton, url, orden) 
											   VALUES (:nombre, :imgFondo, :tipoSlide, :estiloImgProducto, :estiloTextoSlide, :titulo1, :titulo2, :titulo3, :boton, :url, :orden)");
	...
	static public function mdlActualizarSlide($tabla, $rutaFondo, $rutaProducto, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, 
																 tipoSlide = :tipoSlide, 
																 estiloImgProducto = :estiloImgProducto, 
																 estiloTextoSlide = :estiloTextoSlide, 
																 imgFondo = :imgFondo, 
