...
class ModeloComercio{
	...
	static public function mdlActualizarColores($tabla, $id, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET barraSuperior = :barraSuperior, 
	...
	static public function mdlActualizarScript($tabla, $id, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET apiFacebook = :apiFacebook, 
	...
	static public function mdlActualizarInformacion($tabla, $id, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET impuesto = :impuesto, 
                                                                 ...
                                                                 tasaMinimaNal = :tasaMinimaNal, 
																 tasaMinimaInt = :tasaMinimaInt, 
																 pais = :pais, 
																 modoPaypal = :modoPaypal, 
                                                                 clienteIdPaypal = :clienteIdPaypal, 
																 llaveSecretaPaypal = :llaveSecretaPaypal, 
																 modoPayu = :modoPayu, 
                                                                 merchantIdPayu = :merchantIdPayu, 
																 accountIdPayu = :accountIdPayu, 
																 apiKeyPayu = :apiKeyPayu 
                                                				 WHERE id = :id");
