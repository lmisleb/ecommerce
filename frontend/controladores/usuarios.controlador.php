...
class ControladorUsuarios{
				...
				if($respuesta == "ok"){
					...
					$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
						...
						<center>
							...
							<img style="padding:20px; width:10%" src="http://localhost/ecommerce/frontend/vistas/img/plantilla/logo.png">
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
							...
							<img style="padding:20px; width:15%" src="http://localhost/ecommerce/frontend/vistas/img/plantilla/icon-email.png">
	...
	// 	$respuesta = ModeloUsuarios::mdlVerificacionRedesSociales($tabla, $item1, $item2, $valor1, $valor2);
	...
	// 					swal({
	// 						  title: "¡ERROR!",
	// 						  text: "¡Este electrónico '.$datos["email"].', ya está registrado en el sistema a través de '.$datos["modo"].' hágalo por ingresar",
	// 						  type:"error",
	// 						  confirmButtonText: "Cerrar",
	// 						  closeOnConfirm: false
	// 						},
