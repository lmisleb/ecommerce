...
class AjaxUsuarios{
	...
	// 	$respuestaprueba = ControladorUsuarios::ctrVerificacionRedesSociales($datos);

	// 	echo $respuestaprueba;
	...
	public function ajaxValidarDeseo(){

		$datos = array("idUsuario"=>$this->idUsuario,
					   "idProducto"=>$this->idProducto);

		$respuesta = ControladorUsuarios::ctrValidarDeseo($datos);
