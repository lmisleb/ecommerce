...
class ModeloUsuarios{
	...
	/*=============================================
	VERIFICAR USUARIO REDES SOCIALES
	=============================================*/

	// static public function mdlVerificacionRedesSociales($tabla, $item1, $item2, $valor1, $valor2){
	...
	static public function mdlRegistroUsuario($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, password, email, modo, foto, verificacion, emailEncriptado) 
		                                                  VALUES (:nombre, :password, :email, :modo, :foto, :verificacion, :emailEncriptado)");
	...
	static public function mdlValidarDeseo($tabla, $datos){
		...
		if ($total > 0 ){
			...
			$stmt1 = Conexion::conectar()->prepare("INSERT INTO $tabla (id_usuario, id_producto) VALUES (:id_usuario, :id_producto)");
