...
class Paypal{
    ...
    static public function mdlPagoPaypal($datos){
        ...
        # utilizamos un foreach para iterar sobre $payment, 
        # utilizamos el método llamado getLinks() para obtener todos los enlaces que aparecen en el array $payment 
        # y en caso de que $Link->getRel() coincida con 'approval_url' extraemos dicho enlace, 
        # finalmente enviamos al usuario a esa dirección que guardamos en la variable $redirectUrl con el método getHref();
