		...
		<ul>
			...
			<li>
				...
				<div class="slideOpciones slideOpcion1">
					...
					<img class="imgProducto" src="http://localhost/backend/vistas/img/slide/slide1/calzado.png" style="top:15%; right:10%; width:40%">
			...
			<li>
				...
				<div class="slideOpciones slideOpcion2">
					...
					<img class="imgProducto" src="http://localhost/backend/vistas/img/slide/slide2/curso.png" style="top:10%; left:20%; width:20%">
