			...
			<center>
				...
				<?php
					...
					if(count($listaProductos) != 0){
						...
						$pagProductos = ceil(count($listaProductos) / 12); // redondea hacia arriba al número próximo entero mayor
						//$pagProductos = floor(count($listaProductos) / 12); // redondea hacia arriba al número próximo entero menor
