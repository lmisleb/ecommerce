...
<?php
	...
	if($titulosModulos[0] == "ARTÍCULOS GRATUITOS"){
		...
		$valor = 0;
		$modo = "DESC";
		$gratis = ControladorProductos::ctrMostrarProductosActivos($ordenar, $item, $valor, $base, $tope, $modo);
	...
	if($titulosModulos[1] == "LO MÁS VENDIDO"){
		...
		$valor = 1;
		$modo = "DESC";
		$ventas = ControladorProductos::ctrMostrarProductosActivos($ordenar, $item, $valor, $base, $tope, $modo);
	}
	...
	if($titulosModulos[2] == "LO MÁS VISTO"){
		...
		$valor = 1;
		$modo = "DESC";
		$vistas = ControladorProductos::ctrMostrarProductosActivos($ordenar, $item, $valor, $base, $tope, $modo);
