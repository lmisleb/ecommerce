			...
			<hr>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="email" class="form-control text-lowercase" id="regEmail" name="regEmail" placeholder="Correo Electrónico" required>
			...
			<hr>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="email" class="form-control text-lowercase" id="ingEmail" name="ingEmail" placeholder="Correo Electrónico" required>
