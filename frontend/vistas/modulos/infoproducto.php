	...
	<div class="container">
		...
		<div class="row">
			...
			<?php
				...
				$item =  "ruta";
				$valor = $rutas[0];
				$infoproducto = ControladorProductos::ctrMostrarInfoProductoActivos($item, $valor);
					...
					if($infoproducto["detalles"] != null){
						...
						if($infoproducto["tipo"] == "fisico"){
							...
							echo '<div class="col-xs-12">
								...
								<li><i style="margin-right:10px" class="fa fa-play-circle"></i> '.$detalles["Clases"].'</li>
								<li><i style="margin-right:10px" class="fa fa-clock-o"></i> '.$detalles["Tiempo"].'</li>
								<li><i style="margin-right:10px" class="fa fa-check-circle"></i> '.$detalles["Nivel"].'</li>
								<li><i style="margin-right:10px" class="fa fa-info-circle"></i> '.$detalles["Acceso"].'</li>
								<li><i style="margin-right:10px" class="fa fa-desktop"></i> '.$detalles["Dispositivo"].'</li>
								<li><i style="margin-right:10px" class="fa fa-trophy"></i> '.$detalles["Certificado"].'</li>
						...
						if($infoproducto["precio"] == 0){
							...
							<h4 class="col-lg-0 col-md-0 col-xs-12">
								...
								<small>
									...
									<i class="fa fa-shopping-cart" style="margin:0px 5px"></i>'.$infoproducto["ventasGratis"].' inscritos <br>
									<i class="fa fa-eye" style="margin:0px 5px"></i>
									Visto por <span class="vistas" tipo="'.$infoproducto["precio"].'">'.$infoproducto["vistasGratis"].'</span> personas
						...
						if($infoproducto["precio"] == 0){
							...
							echo '<h4 class="col-md-12 col-sm-0 col-xs-0">
								...
								<span class="label label-default" style="font-weight:100">
									...
									<i class="fa fa-clock-o" style="margin-right:5px"></i>'.$infoproducto["entrega"].' días hábiles para la entrega  |
							...
							<h4 class="col-lg-0 col-md-0 col-xs-12">
								...
								<small>
									...
									<i class="fa fa-clock-o" style="margin-right:5px"></i>'.$infoproducto["entrega"].' días hábiles para la entrega  <br>
									<i class="fa fa-shopping-cart" style="margin:0px 5px"></i>'.$infoproducto["ventasGratis"].' solicitudes  <br>
									<i class="fa fa-eye" style="margin:0px 5px"></i>
									Visto por <span class="vistas" tipo="'.$infoproducto["precio"].'">'.$infoproducto["vistasGratis"].' </span> personas 
						...
						echo '<div class="col-md-6 col-xs-12">';
							...
							if(isset($_SESSION["validarSesion"]) && $_SESSION["validarSesion"] == "ok"){
								...
								if($infoproducto["tipo"]=="virtual"){
									...
									echo '<button class="btn btn-default btn-block btn-lg backColor agregarGratis" 
										   idProducto="'.$infoproducto["id"].'" 
										   idUsuario="'.$_SESSION["id"].'" 
										   tipo="'.$infoproducto["tipo"].'"
										   titulo="'.$infoproducto["titulo"].'">ACCEDER AHORA</button>';
									...
									echo '<button class="btn btn-default btn-block btn-lg backColor agregarGratis" 
										   ...
										   idUsuario="'.$_SESSION["id"].'" 
										   tipo="'.$infoproducto["tipo"].'"
										   titulo="'.$infoproducto["titulo"].'">SOLICITAR AHORA</button>
										   <br>
										   <div class="col-xs-12 panel panel-info text-left">
											  <strong>¡Atención!</strong>
											  	El producto a solicitar es totalmente gratituo y se enviará a la dirección solicitada, solo se cobrará los cargos por el envío.
									</div>';
								...
								echo '<a href="#modalIngreso" data-toggle="modal"> <button class="btn btn-default btn-block btn-lg backColor">SOLICITAR AHORA</button> </a>';
...
<div class="container-fluid productos">
	...
	<div class="container">
			...
			<div class="col-xs-12 tituloDestacado">
				...
				<div class="col-sm-6 col-xs-12">
					...
					<?php
						...
						$rutaArticulosDestacados = ControladorProductos::ctrMostrarSubCategoriasActivas($item, $valor);
		...
		<?php
			...
			$tope = 4;
			$modo = "Rand()";
			$relacionados = ControladorProductos::ctrMostrarProductosActivos($ordenar, $item, $valor, $base, $tope, $modo);
		...
		<div class="modal-body modalTitulo">
			...
			<div class="contenidoCheckout">
				...
				<div class="formEnvio row">
					...
					<h4 class="text-center well text-muted">INFORMACIÓN DE ENVÍO</h4>
				...
				<div class="form-pago row">
					...
					<h4 class="text-center well text-muted">ELIGE LA FORMA DE PAGO</h4>
				...
				<div class="listaProductos row">
					...
					<h4 class="text-center well text-muted">PRODUCTOS A COMPRAR</h4>
